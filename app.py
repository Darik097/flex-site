...
CATALOG_PROJECTS = [
    {
        ...
        "featured_image": "images/stone_home-optimized.jpg",
...
CATALOG_BEFORE_AFTER_PROJECTS = [
    ...
    },
    {
        ...
        "before_image": "images/before2.jpg",
        "before_alt": "Площадка перед домом до завершения работ",
        "after_image": "images/after2.jpg",
...
LANDING_PAGES = {
    "kamennyj-kover-ufa": {
        ...
        "hero_image": "images/stone_home-optimized.jpg",
    ...
    "kamennyj-kover-cena": {
        ...
        "hero_image": "images/home_project2-optimized.jpg",
    ...
    "kamennyj-kover-dlya-terrasy": {
        ...
        "hero_image": "images/stone_home1-optimized.jpg",
    ...
    "kamennyj-kover-dlya-stupenej": {
        ...
        "hero_image": "images/stone_home2-optimized.jpg",
